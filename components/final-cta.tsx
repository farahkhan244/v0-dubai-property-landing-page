      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground text-balance">
            Ready to Explore Dubai's Best Property Opportunities?
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-6">
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 h-14 border-primary text-foreground hover:bg-primary/10 transition-all hover:scale-105 bg-transparent duration-300"
              asChild
            >
              <a href="mailto:farahkhan244@gmail.com">
